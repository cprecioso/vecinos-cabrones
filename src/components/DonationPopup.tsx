...
const DonationPopup = () => {
  ...
  const dismissPopup = useCallback(() => setVisible(false), []);
        ...
        >
          <div className={styles.donationPanel}>
            ...
            <p className={styles.donationText}>
              ...
              Mantener esta web tiene costes de servidores, almacenamiento y
              ancho de banda. Tu donación nos ayuda a seguir ofreciendo este
              servicio a todos los fans de Aquí no hay quien viva.
            </p>
            ...
            <div className={styles.donationActions}>
              ...
              <button
                className={styles.donationSecondaryBtn}
                onClick={dismissPopup}
              >
                Ahora no
              </button>
